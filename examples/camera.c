...
void render_mesh_3d(ecs_iter_t *it) {
  ecs_field(it, GFX_Transform, 0);
  ecs_field(it, GFX_Mesh3D, 1);
}
...
int main(void) {
  ...
  ECS_SYSTEM(world, render_mesh_3d, EcsOnUpdate, GFX_Transform, GFX_Mesh3D);
